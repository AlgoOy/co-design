...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "turnstile.autotvin.dat"
	set constFileTvOut       "turnstile.autotvout.dat"
	set constFileHdlTvIn     "turnstile.autohdltvin.dat"
	set constFileHdlTvOut    "turnstile.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
