...
// wrapc file define:
#define AUTOTB_TVIN_lock "../tv/cdatafile/c.turnstile.autotvin_lock.dat"
#define AUTOTB_TVOUT_lock "../tv/cdatafile/c.turnstile.autotvout_lock.dat"
#define AUTOTB_TVIN_pass "../tv/cdatafile/c.turnstile.autotvin_pass.dat"
#define AUTOTB_TVOUT_pass "../tv/cdatafile/c.turnstile.autotvout_pass.dat"
#define AUTOTB_TVIN_brush "../tv/cdatafile/c.turnstile.autotvin_brush.dat"
#define AUTOTB_TVOUT_brush "../tv/cdatafile/c.turnstile.autotvout_brush.dat"
...
extern "C"
void turnstile_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_turnstile_hw(void* __xlx_apatb_param_lock, void* __xlx_apatb_param_pass, void* __xlx_apatb_param_brush)
{
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_lock),
#endif
  };
  port0.param = __xlx_apatb_param_lock;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_pass),
#endif
  };
  port1.param = __xlx_apatb_param_pass;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_brush),
#endif
  };
  port2.param = __xlx_apatb_param_brush;
  ...
  try {
    ...
    turnstile_hw_stub_wrapper(__xlx_apatb_param_lock, __xlx_apatb_param_pass, __xlx_apatb_param_brush);
