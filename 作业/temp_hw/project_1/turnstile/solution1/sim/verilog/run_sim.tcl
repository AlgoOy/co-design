...
if {[file isfile turnstile.autotvin.dat]} {
	file delete -force turnstile.autotvin.dat
}

if {[file isfile turnstile.autotvout.dat]} {
	file delete -force turnstile.autotvout.dat
}
