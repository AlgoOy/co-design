...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "balance.autotvin.dat"
	set constFileTvOut       "balance.autotvout.dat"
	set constFileHdlTvIn     "balance.autohdltvin.dat"
	set constFileHdlTvOut    "balance.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
