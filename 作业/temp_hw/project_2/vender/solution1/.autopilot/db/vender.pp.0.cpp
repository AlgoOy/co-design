...
# 2 "<built-in>" 2
# 1 "../project_2_src/vender.cpp" 2
# 1 "../project_2_src/vender.h" 1
...
# 2 "../project_2_src/vender.h" 2
__attribute__((sdx_kernel("balance", 0))) void balance(ap_int<3> *sum, ap_int<2> cash, ap_int<2> *tissue);
# 2 "../project_2_src/vender.cpp" 2
__attribute__((sdx_kernel("balance", 0))) void balance(ap_int<3> *sum, ap_int<2> cash, ap_int<2> *tissue){
#line 15 "C:/Users/24073/Desktop/temp_hw/project_2/vender/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=balance
# 2 "../project_2_src/vender.cpp"
